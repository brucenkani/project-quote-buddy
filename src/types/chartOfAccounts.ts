...
export const defaultChartOfAccounts: Omit<ChartAccount, 'id' | 'createdAt'>[] = [
  ...
  { accountNumber: '8100', accountName: 'Direct Labour', accountType: 'expense', isDefault: true },
  { accountNumber: '8101', accountName: 'Subcontracting Costs', accountType: 'expense', isDefault: true },
  { accountNumber: '8102', accountName: 'Freight & Import Duties', accountType: 'expense', isDefault: true },
  { accountNumber: '8103', accountName: 'Administrative Expenses', accountType: 'expense', isDefault: true },
  { accountNumber: '8104', accountName: 'Salaries and Wages (Admin)', accountType: 'expense', isDefault: true },
  { accountNumber: '8105', accountName: 'Office Rent', accountType: 'expense', isDefault: true },
  { accountNumber: '8106', accountName: 'Telephone & Internet', accountType: 'expense', isDefault: true },
  { accountNumber: '8107', accountName: 'Stationery & Printing', accountType: 'expense', isDefault: true },
  { accountNumber: '8108', accountName: 'Insurance (Admin)', accountType: 'expense', isDefault: true },
  { accountNumber: '8109', accountName: 'Selling and Distribution Expenses', accountType: 'expense', isDefault: true },
  { accountNumber: '8110', accountName: 'Advertising & Marketing', accountType: 'expense', isDefault: true },
  { accountNumber: '8111', accountName: 'Travel & Accommodation (Sales)', accountType: 'expense', isDefault: true },
  { accountNumber: '8112', accountName: 'Motor Vehicle Expenses', accountType: 'expense', isDefault: true },
  { accountNumber: '8113', accountName: 'Finance Costs', accountType: 'expense', isDefault: true },
  { accountNumber: '8114', accountName: 'Interest Expense – Loans', accountType: 'expense', isDefault: true },
  { accountNumber: '8115', accountName: 'Bank Charges', accountType: 'expense', isDefault: true },
  { accountNumber: '8116', accountName: 'Legal & Professional Fees', accountType: 'expense', isDefault: true },
  { accountNumber: '8117', accountName: 'Audit & Accounting Fees', accountType: 'expense', isDefault: true },
  { accountNumber: '8118', accountName: 'Consulting Fees', accountType: 'expense', isDefault: true },
  { accountNumber: '8119', accountName: 'Current Income Tax Expense', accountType: 'expense', isDefault: true },
  { accountNumber: '8120', accountName: 'Deferred Tax Expense/Income', accountType: 'expense', isDefault: true },
  
  // Other Comprehensive Income (9xxx)
  { accountNumber: '9100', accountName: 'Revaluation Gains on PPE', accountType: 'expense', isDefault: true },
  { accountNumber: '9101', accountName: 'Actuarial Gains/Losses on Pensions', accountType: 'expense', isDefault: true },
];
