...
export const defaultChartOfAccounts: Omit<ChartAccount, 'id' | 'createdAt'>[] = [
  ...
  { accountNumber: '8106', accountName: 'Selling and Distribution Expenses', accountType: 'expense', isDefault: true },
  { accountNumber: '8107', accountName: 'Advertising & Marketing', accountType: 'expense', isDefault: true },
  { accountNumber: '8108', accountName: 'Travel & Accommodation (Sales)', accountType: 'expense', isDefault: true },
  { accountNumber: '8109', accountName: 'Motor Vehicle Expenses', accountType: 'expense', isDefault: true },
  { accountNumber: '8110', accountName: 'Finance Costs', accountType: 'expense', isDefault: true },
  { accountNumber: '8111', accountName: 'Interest Expense – Loans', accountType: 'expense', isDefault: true },
  { accountNumber: '8112', accountName: 'Bank Charges', accountType: 'expense', isDefault: true },
  { accountNumber: '8113', accountName: 'Legal & Professional Fees', accountType: 'expense', isDefault: true },
  { accountNumber: '8114', accountName: 'Audit & Accounting Fees', accountType: 'expense', isDefault: true },
  { accountNumber: '8115', accountName: 'Consulting Fees', accountType: 'expense', isDefault: true },
  { accountNumber: '8116', accountName: 'Current Income Tax Expense', accountType: 'expense', isDefault: true },
  { accountNumber: '8117', accountName: 'Deferred Tax Expense/Income', accountType: 'expense', isDefault: true },
